...
cv_scores = cross_val_score(regressor, X_train_processed, y_train, cv=5)  # cv=5 means 5-fold cross-validation

# Print the cross-validation scores without scientific notation
print("Cross-Validation Scores:", [np.format_float_positional(score) for score in cv_scores])
